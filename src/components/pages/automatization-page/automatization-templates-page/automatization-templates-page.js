...
const AutomatizationTemplatesPage = ({ getSemaphoreTaskOutput, getSemaphoreTasks, jobTemplateList, setSelectedTemplateIds, keysList, setSelectedKeysIds, selectedTemplatesIds, runSemaphoreTemplate }) => {
    ...
    return (
        <div>
            <h3>AutomatizationTemplatesPage</h3>
            <div className='row'>
...
export default AutomatizationTemplatesPage